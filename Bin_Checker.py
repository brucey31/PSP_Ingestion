...
cursor.execute("select distinct adyen.issuer_id from adyen_raw adyen left join bank_bin_code_list list on list.bin = adyen.issuer_id where left(adyen.issuer_id,4) between 0 and 9999 and len(adyen.issuer_id) = 6 and list.bin is null limit 200;")
